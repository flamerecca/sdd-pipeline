...
REPO_URL="https://github.com/flamerecca/sdd-pipeline.git"
SCOPE="global"
...
echo "請重新啟動 Claude Code，即可套用 sdd-pipeline Skill，以及 openapi-contract-designer、contract-drift-auditor 兩個 Agent。"
